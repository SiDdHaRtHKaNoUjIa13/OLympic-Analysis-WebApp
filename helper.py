...
def medal_tally(df):
    ...
    # conerting the float unwanted decimal zeri oso into int
...
def yearwise_medal_tally(df,country):
    temp_df = df.dropna(subset=['Medal'])
    # we will count for the single medal if the country wins in team game rather considering each player won seperately
...
def country_event_heatmpa(df,country):
    temp_df = df.dropna(subset=['Medal'])
    # we will count for the single medal if the country wins in team game rather considering each player won seperately
